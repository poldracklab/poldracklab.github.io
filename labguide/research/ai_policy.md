...
It is the researcher's ultimately responsiblity to vouch for any AI-generated outputs, so those outputs should be validated and verified just as one would for an output from an untrusted research assistant.
